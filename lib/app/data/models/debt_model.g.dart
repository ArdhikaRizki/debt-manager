...
DebtModel _$DebtModelFromJson(Map<String, dynamic> json) => DebtModel(
  ...
  counterpartId: json['counterpartId'] == null
      ? null
      : const SafeIntConverter().fromJson(json['counterpartId']),
  ...
  groupId: json['group_id'] == null
      ? null
      : const SafeIntConverter().fromJson(json['group_id']),
...
Map<String, dynamic> _$DebtModelToJson(DebtModel instance) =>
    <String, dynamic>{
      ...
      'counterpartId': instance.counterpartId == null
          ? null
          : const SafeIntConverter().toJson(instance.counterpartId!),
